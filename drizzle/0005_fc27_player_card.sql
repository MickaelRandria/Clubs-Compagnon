-- Carte joueur FC 27 : codes de poste EA FC en français, identité maillot, morphologie et profil de jeu.
-- Les codes sont renommés sur place : aucune fiche existante n'est perdue ni convertie à la main.
ALTER TYPE "public"."fc27_position" RENAME VALUE 'GK' TO 'G';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'CB' TO 'DC';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'LB' TO 'DG';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'RB' TO 'DD';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'CDM' TO 'MDC';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'CM' TO 'MC';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'CAM' TO 'MOC';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'LM' TO 'MG';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'RM' TO 'MD';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'LW' TO 'AG';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'RW' TO 'AD';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" RENAME VALUE 'ST' TO 'BU';--> statement-breakpoint
ALTER TYPE "public"."fc27_position" ADD VALUE IF NOT EXISTS 'AT';--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "kit_number" smallint;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "preferred_foot" text;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "height_cm" smallint;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "weight_kg" smallint;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "archetype" text;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "play_styles" text[] DEFAULT '{}'::text[] NOT NULL;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "weak_foot" smallint;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD COLUMN "skill_moves" smallint;--> statement-breakpoint
CREATE UNIQUE INDEX "fc27_player_kit_number_key" ON "fc27_player_profiles" USING btree ("campaign_id","kit_number") WHERE "fc27_player_profiles"."kit_number" is not null;--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_kit_number_check" CHECK ("fc27_player_profiles"."kit_number" between 1 and 99);--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_foot_check" CHECK ("fc27_player_profiles"."preferred_foot" in ('Droit', 'Gauche'));--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_height_check" CHECK ("fc27_player_profiles"."height_cm" between 160 and 200);--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_weight_check" CHECK ("fc27_player_profiles"."weight_kg" between 50 and 100);--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_archetype_check" CHECK (char_length("fc27_player_profiles"."archetype") between 1 and 60);--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_play_styles_check" CHECK (cardinality("fc27_player_profiles"."play_styles") <= 3);--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_weak_foot_check" CHECK ("fc27_player_profiles"."weak_foot" between 1 and 5);--> statement-breakpoint
ALTER TABLE "fc27_player_profiles" ADD CONSTRAINT "fc27_player_skill_moves_check" CHECK ("fc27_player_profiles"."skill_moves" between 1 and 5);--> statement-breakpoint
-- Identique à la version 0004, sauf la branche 'player' (carte complète, numéro de maillot unique, un poste secondaire).
  ...
  WHEN 'player' THEN
    ...
    IF p_input ? 'profileId' THEN
      UPDATE fc27_player_profiles SET
        ...
        archetype = p_input->>'archetype', play_styles = ARRAY(SELECT jsonb_array_elements_text(p_input->'mainPlayStyles')),
    ...
    ELSE
      INSERT INTO fc27_player_profiles(campaign_id, pseudo, in_game_name, kit_number, primary_position, preferred_foot,
          height_cm, weight_kg, archetype, play_styles, weak_foot, skill_moves, notes)
        VALUES(c.id, p_input->>'pseudo', p_input->>'kitName', (p_input->>'kitNumber')::smallint,
          ...
          ARRAY(SELECT jsonb_array_elements_text(p_input->'mainPlayStyles')),
