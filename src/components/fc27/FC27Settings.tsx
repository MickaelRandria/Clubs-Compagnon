...
export function FC27Settings({ state, onClose }: { state: FC27State; onClose: () => void }) {
  ...
  const descriptions = {
    start: 'La liste des noms sera figée. Chaque pseudo pourra voter une seule fois, jusqu’à ta clôture manuelle.',
  ...
  return <FC27Dialog title="Réglages FC 27" onClose={onClose}>
    <p className="fc27-muted">Le lancement et la clôture du vote se décident ici. Sans compte administrateur, ces commandes restent accessibles à tous, sur la confiance.</p>
